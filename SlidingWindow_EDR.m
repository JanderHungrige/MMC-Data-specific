function [EDR_win_300,EDR_win_30,t_300,t_30]=SlidingWindow_ECG(EDR,t_EDR,Neonate,saving,folder,factor,win)  
...
%% Nested saving
    function Saving(Feature,savefolder, Neonate, win,S)
        if exist('Feature','var')==1
            ...
            save([savefolder name '_Session_' num2str(S) '_win_' num2str(win) '_' num2str(Neonate)],'Feature')
        else
